...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=312aa16a147db1e91489d1134144f202&units=metric';
	...
	module.exports = {
	  getTemp: function getTemp(location) {
	    ...
	    return axios.get(requestUrl).then(function (res) {
	      ...
	      throw new Error(res.data.message);
	    }); //make the request; call axios.get = gets the URL and bring u back the result
	  }
	};
